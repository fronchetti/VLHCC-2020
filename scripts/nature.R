...
nature <- function(){
  ...
  #  Data Loading  #
  ################## 
  atom_nature_metrics <- load_data(paste0(working_directory, "metrics/results_nature/atom_nature_metrics.csv"))
  electron_nature_metrics <- load_data(paste0(working_directory, "metrics/results_nature/electron_nature_metrics.csv"))
  gitlfs_nature_metrics <- load_data(paste0(working_directory, "metrics/results_nature/gitlfs_nature_metrics.csv"))
  hubot_nature_metrics <- load_data(paste0(working_directory, "metrics/results_nature/hubot_nature_metrics.csv"))
  linguist_nature_metrics <- load_data(paste0(working_directory, "metrics/results_nature/linguist_nature_metrics.csv"))
  ...
  write.table(results_nature) # Prints the table

  ###################
  #  CSV Exporting  #
  ###################
  grid.table(results_nature)
  write.csv(results_nature, "plots/projects_nature.csv")
}
